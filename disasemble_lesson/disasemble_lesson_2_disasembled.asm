...
0000000000001149 <main>:
    ...
    1151:	48 8d 15 b0 0e 00 00 	lea    0xeb0(%rip),%rdx        # 2008 <_IO_stdin_used+0x8>
    1158:	48 8d 35 dd 0e 00 00 	lea    0xedd(%rip),%rsi        # 203c <_IO_stdin_used+0x3c>
    115f:	bf 01 00 00 00       	mov    $0x1,%edi
    1164:	b8 00 00 00 00       	mov    $0x0,%eax
    1169:	e8 e2 fe ff ff       	callq  1050 <__printf_chk@plt>
    116e:	48 8d 15 93 0e 00 00 	lea    0xe93(%rip),%rdx        # 2008 <_IO_stdin_used+0x8>
    1175:	48 8d 35 c0 0e 00 00 	lea    0xec0(%rip),%rsi        # 203c <_IO_stdin_used+0x3c>
    117c:	bf 01 00 00 00       	mov    $0x1,%edi
    1181:	b8 00 00 00 00       	mov    $0x0,%eax
    1186:	e8 c5 fe ff ff       	callq  1050 <__printf_chk@plt>
    118b:	48 8d 15 76 0e 00 00 	lea    0xe76(%rip),%rdx        # 2008 <_IO_stdin_used+0x8>
    1192:	48 8d 35 a3 0e 00 00 	lea    0xea3(%rip),%rsi        # 203c <_IO_stdin_used+0x3c>
    1199:	bf 01 00 00 00       	mov    $0x1,%edi
    119e:	b8 00 00 00 00       	mov    $0x0,%eax
    11a3:	e8 a8 fe ff ff       	callq  1050 <__printf_chk@plt>
    11a8:	48 8d 15 59 0e 00 00 	lea    0xe59(%rip),%rdx        # 2008 <_IO_stdin_used+0x8>
    11af:	48 8d 35 86 0e 00 00 	lea    0xe86(%rip),%rsi        # 203c <_IO_stdin_used+0x3c>
    11b6:	bf 01 00 00 00       	mov    $0x1,%edi
    11bb:	b8 00 00 00 00       	mov    $0x0,%eax
    11c0:	e8 8b fe ff ff       	callq  1050 <__printf_chk@plt>
