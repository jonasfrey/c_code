...
int main() {
   ...
   printf("\nvalue of '#define TAU l6.282': %f", 6.282);

   printf("\nvalue of '#define PI TAU / 2': %f", 6.282 / 2);

   printf("\n the sum of 2(x) and 5(y) is %i", 2 +5);



   printf("\n again, the sum of 2(x) and 5(y) is %i", 2 +5);

   if(12 > 20){ printf("\nthe bigger number is a(%i)", 12); }else{ printf("\nthe bigger number is b(%i)", 20); };
